...
function draw() {
  ...
  if(packageSprite.y > 450 && packageSprite.x > rect2.x && packageSprite.x < rect3.x){
	textSize(20);
	stroke("green");
    text("MISSION SUCCESSFUL",300,150)
  }
  ...
  text("-Due to frequent zombie attacks the location of the dropping point keeps ",30,60)
  text("on changing ",30,90)
  text("-Your mission is to drop the package at the dropping point",30,120)
  stroke("yellow")
  text("A L L  T H E  B E S T  ! ! !",30,580)
}
